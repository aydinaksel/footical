    ...
    view! {
        <header class="bg-white shadow-sm border-b border-gray-200">
            <nav class="max-w-md mx-auto px-4 py-3 flex gap-6">
                <A href="/">
                    <span class=nav_class("/")>"Home"</span>
                </A>
                <A href="/fixtures">
                    <span class=nav_class("/fixtures")>"Fixtures"</span>
                </A>
                <A href="/today">
                    <span class=nav_class("/today")>"Today"</span>
                </A>
                <A href="/team/fixtures">
                    <span class=nav_class("/team/fixtures")>"Grasshoppers"</span>
                </A>
                <span class="ml-auto">
                    <A href="/admin">
                        <span class=nav_class("/admin")>"Admin"</span>
                    </A>
                </span>
            </nav>
        </header>
