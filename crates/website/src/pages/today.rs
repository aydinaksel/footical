...
type DivisionGroup = (String, Option<String>, Vec<TodayFixture>);
type LeagueGroup = (String, Vec<DivisionGroup>);

fn group_by_league(fixtures: Vec<TodayFixture>) -> Vec<LeagueGroup> {
